...
const UserMergeModal = ({ 
    ...
    return (
        <div onClick={(e) => { if (e.target === e.currentTarget) setIsMergeModalOpen(false); }} className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-md flex items-center justify-center p-4">
            <motion.div 
