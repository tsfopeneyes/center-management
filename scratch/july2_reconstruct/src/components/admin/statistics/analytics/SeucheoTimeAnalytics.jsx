...
const SeucheoTimeAnalytics = ({ schoolLogs, users, periodType, selectedDate, regionFilter }) => {
    const data = useMemo(() => {
        return processSeucheoAnalytics(schoolLogs, users, periodType, selectedDate, regionFilter);
    }, [schoolLogs, users, periodType, selectedDate, regionFilter]);
